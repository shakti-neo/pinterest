...
ActiveRecord::Schema.define(version: 20170522100232) do
  ...
  add_index "pins", ["cached_votes_down"], name: "index_pins_on_cached_votes_down", using: :btree
  add_index "pins", ["cached_votes_score"], name: "index_pins_on_cached_votes_score", using: :btree
  add_index "pins", ["cached_votes_total"], name: "index_pins_on_cached_votes_total", using: :btree
  add_index "pins", ["cached_votes_up"], name: "index_pins_on_cached_votes_up", using: :btree
